...
public class PythonRunner
{
      ...
      { 
         ...
         var pi = new ProcessStartInfo 
         {
            ...
            FileName = "/bin/bash",
            //Arguments = $"/c /opt/anaconda3/bin/conda activate {Environment}&&python {strCommand}", /* Gli passo il path per arrivare ad anaconda, così può essere attivato l'environmente. "&&" indica un secondo comando che sarà "phyton ...". */     
            Arguments = $"/c /opt/anaconda3/etc/profile.d/conda.sh && conda activate {Environment} && python {strCommand}",
            //Arguments = $"-c \"source /opt/anaconda3/etc/profile.d/conda.sh && conda activate {Environment} && python {strCommand}\"",
